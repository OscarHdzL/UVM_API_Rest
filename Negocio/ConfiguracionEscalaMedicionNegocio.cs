        ...
        public async Task<TipoAccion> Get(int? id, int pageSize, int pageNumber)
        {
            try
            {
                ...
                foreach (var escala in resultados) {
                    ...
                    escalaMedicion.Normativa = escala.Normativa;
                    escalaMedicion.Evidencia = escala.Evidencia;
                    escalaMedicion.Descripcion = escala.Descripcion;
                    escalaMedicion.Cantidad = escala.Cantidad;
