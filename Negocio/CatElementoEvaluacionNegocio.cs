...
namespace Negocio
{
    public class CatElementoEvaluacionNegocio
    {
        ...
        public async Task<TipoAccion> Insertar(CatElementoEvaluacion entidad)
        {
            try
            {
                ...
                await ctx.Database.ExecuteSqlInterpolatedAsync($@"EXEC sp_ElementoEvaluacion_Actualiza
        ...
        public async Task<TipoAccion> Actualizar(CatElementoEvaluacion entidad)
        {
            try
            {
                var parametroId = new SqlParameter("@idRespuesta", SqlDbType.Int);
