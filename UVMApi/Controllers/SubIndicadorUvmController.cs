...
namespace UVMApi.Controllers
{
    ...
    public class SubIndicadorUvmController : ControllerBase
    {


        private readonly ILogger<SubIndicadorUvmController> _logger;
        public SubIndicadorUvmNegocio negocio = new SubIndicadorUvmNegocio();

        public SubIndicadorUvmController(ILogger<SubIndicadorUvmController> logger)
        {
            _logger = logger;
        }
        ...
        [HttpPost]
        [Route("[action]")]
        public Task<TipoAccion> Add(SubIndicadorUvmDTO entidad)
        {
        ...
        [HttpPut]
        [Route("[action]")]
        public Task<TipoAccion> Update(SubIndicadorUvmDTO entidad)
        {
