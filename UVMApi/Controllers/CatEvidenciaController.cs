...
namespace UVMApi.Controllers
{
    ...
    public class CatEvidenciaController : ControllerBase
    {
  

        private readonly ILogger<CatEvidenciaController> _logger;
        public CatEvidenciaNegocio negocio = new CatEvidenciaNegocio();

        public CatEvidenciaController(ILogger<CatEvidenciaController> logger)
        {
            _logger = logger;
        }
        ...
        [HttpPost]
        [Route("[action]")]
        public Task<TipoAccion> Add(EvidenciaDTO entidad)
        {
        ...
        [HttpPut]
        [Route("[action]")]
        public Task<TipoAccion> Update(EvidenciaDTO entidad)
        {
