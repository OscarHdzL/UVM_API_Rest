...
namespace UVMApi.Controllers
{
    ...
    public class IndicadorUvmController : ControllerBase
    {


        private readonly ILogger<IndicadorUvmController> _logger;
        public IndicadorUvmNegocio negocio = new IndicadorUvmNegocio();

        public IndicadorUvmController(ILogger<IndicadorUvmController> logger)
        {
            _logger = logger;
        }
        ...
        [HttpPost]
        [Route("[action]")]
        public Task<TipoAccion> Add(IndicadorUvmDTO entidad)
        {
        ...
        [HttpPut]
        [Route("[action]")]
        public Task<TipoAccion> Update(IndicadorUvmDTO entidad)
        {
